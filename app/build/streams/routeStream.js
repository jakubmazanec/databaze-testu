...
let routeStream = router.add(`${urlRoot}(/)(:language)(/:page)(/:pageId)(/:pageName)(/)`).map(value => {
    ...
    if (page === 'user') {} else if (page === 'method') {} else if (page === 'resource') {} else if (page === 'resources') {} else if (page === 'login') {
        pageId = null;
        pageName = null;
    } else if (page === 'signup') {
        pageId = null;
