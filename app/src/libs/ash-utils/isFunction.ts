 ...
 * @returns {boolean}
 */
let isFunction = (value: any) => typeof value === 'function' || false; // Avoid a Chakra JIT bug in compatibility modes of IE 11; https://github.com/jashkenas/underscore/issues/1621
